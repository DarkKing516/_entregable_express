...
const { getPedidosPage, agregarPedido, verDetallePedido, eliminarPedido, actualizarPedido } = require('../controllers/pedidosController'); // Asegúrate de tener el controlador necesario
...
router.post('/editarPedido/:id', actualizarPedido);
